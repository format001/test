...
@typography-heading-margin-bottom: @spacing-7;
@typography-heading-margin-top: @spacing-none;
@card-border-width-title-bottom: @border-none;
@card-size-default-padding-horizontal-title: @spacing-8;
@card-size-default-padding-horizontal-body: @spacing-8;
@card-size-default-padding-vertical-body: @spacing-8;
@card-border-width: @border-1;
@descriptions-font-weight-title: @font-weight-500;
@descriptions-color-title: @color-text-1;
@descriptions-font-weight-text-label: @font-weight-400;
@descriptions-size-default-title-margin-bottom: @spacing-6;
@card-border-radius: @border-radius-medium;
@card-border-radius-no-border: @border-radius-medium;
@list-border-radius: @border-radius-small;
@card-size-small-padding-vertical-body: @spacing-7;
