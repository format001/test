...
function Popover(baseProps, ref) {
    var _a = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _a.getPrefixCls, componentConfig = _a.componentConfig, rtl = _a.rtl;
    ...
    return (react_1.default.createElement(Tooltip_1.default, __assign({}, rest, { ref: ref, style: __assign({ maxWidth: 350 }, style), className: className, prefixCls: prefixCls, getPopupContainer: getPopupContainer, position: position, trigger: trigger, content: function () {
            var _a;
            return (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-inner", (_a = {}, _a[prefixCls + "-inner-rtl"] = rtl, _a)) },
                title ? (react_1.default.createElement("div", { className: prefixCls + "-title" }, (0, is_1.isFunction)(title) ? title() : title)) : null,
                react_1.default.createElement("div", { className: prefixCls + "-inner-content" }, (0, is_1.isFunction)(content) ? content() : content)));
