...
var Search = react_1.default.forwardRef(function (props, ref) {
    ...
    return (react_1.default.createElement(input_1.default, __assign({}, (0, omit_1.default)(rest, ['onSearch']), { disabled: disabled, className: classNames, style: style, ref: ref, placeholder: placeholder, addAfter: searchButton ? (react_1.default.createElement(Button_1.default, { disabled: disabled, size: rest.size, className: prefixCls + "-btn", type: "primary", onClick: onSearch, loading: loading, loadingFixedWidth: true, icon: searchButton === true && !loading && react_1.default.createElement(IconSearch_1.default, null) }, searchButton !== true && searchButton)) : null, suffix: !searchButton && (loading ? react_1.default.createElement(IconLoading_1.default, null) : react_1.default.createElement(IconSearch_1.default, { onClick: onSearch })), onChange: function (value, e) {
            setValue(value);
