...
function Preview(baseProps, ref) {
    ...
    var _f = __read(useState(mergedSrc), 2), previewImgSrc = _f[0], setPreviewImgSrc = _f[1];
    ...
    var _h = useImageStatus('loading'), isLoading = _h.isLoading, isLoaded = _h.isLoaded, setStatus = _h.setStatus;
    var _j = __read(useState(false), 2), toolbarSimple = _j[0], setToolbarSimple = _j[1];
    var _k = __read(useState({ x: 0, y: 0 }), 2), translate = _k[0], setTranslate = _k[1];
    var _l = __read(useState(1), 2), scale = _l[0], setScale = _l[1];
    var _m = __read(useState(false), 2), scaleValueVisible = _m[0], setScaleValueVisible = _m[1];
    var _o = __read(useState(0), 2), rotate = _o[0], setRotate = _o[1];
    var _p = __read(useState(false), 2), moving = _p[0], setMoving = _p[1];
    ...
    var _q = __read(useState(), 2), container = _q[0], setContainer = _q[1];
