...
function Preview(baseProps, ref) {
    ...
    var _h = (0, useImageStatus_1.default)('loading'), isLoading = _h.isLoading, isLoaded = _h.isLoaded, setStatus = _h.setStatus;
    var _j = __read((0, react_1.useState)(false), 2), toolbarSimple = _j[0], setToolbarSimple = _j[1];
    var _k = __read((0, react_1.useState)({ x: 0, y: 0 }), 2), translate = _k[0], setTranslate = _k[1];
    var _l = __read((0, react_1.useState)(1), 2), scale = _l[0], setScale = _l[1];
    var _m = __read((0, react_1.useState)(false), 2), scaleValueVisible = _m[0], setScaleValueVisible = _m[1];
    var _o = __read((0, react_1.useState)(0), 2), rotate = _o[0], setRotate = _o[1];
    var _p = __read((0, react_1.useState)(false), 2), moving = _p[0], setMoving = _p[1];
    ...
    var _q = __read((0, react_1.useState)(), 2), container = _q[0], setContainer = _q[1];
                    ...
                    react_1.default.createElement("div", { ref: refWrapper, className: previewPrefixCls + "-wrapper", onClick: onOutsideImgClick },
                        react_1.default.createElement("div", { ref: refImageContainer, className: previewPrefixCls + "-img-container", style: { transform: "scale(" + scale + ", " + scale + ")" }, onClick: onOutsideImgClick },
                            react_1.default.createElement("img", __assign({ onWheel: onWheelZoom, ref: refImage, className: (0, classNames_1.default)(imgClassName, previewPrefixCls + "-img", (_b = {},
                                    ...
                                    _b)), style: __assign(__assign({}, imgStyle), { transform: "translate(" + translate.x + "px, " + translate.y + "px) rotate(" + rotate + "deg)" }) }, restImgAttributes, { onLoad: onImgLoaded, onError: onImgLoadError, onMouseDown: function (event) {
                                    // only trigger onMoveStart when press mouse left button
                                    event.button === 0 && onMoveStart(event);
                                }, key: previewImgSrc, src: previewImgSrc })),
