...
exports.componentCssMatchers = exports.globalCssMatchers = exports.fullCssMatchers = exports.componentLessMatchers = exports.globalLessMatchers = exports.fullLessMatchers = exports.iconComponentMatchers = exports.iconListMatchers = exports.libraryName = void 0;
exports.libraryName = '@arco-design/web-react';
exports.iconListMatchers = [`${exports.libraryName}/icon/index\\.js[^/]*$`];
