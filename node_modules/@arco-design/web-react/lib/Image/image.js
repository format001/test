...
function Image(baseProps, ref) {
    ...
    var _e = (0, useImageStatus_1.default)('beforeLoad'), isLoading = _e.isLoading, isError = _e.isError, isLoaded = _e.isLoaded, isLazyLoad = _e.isLazyLoad, isBeforeLoad = _e.isBeforeLoad, setStatus = _e.setStatus;
