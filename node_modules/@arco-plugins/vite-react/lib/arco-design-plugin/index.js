...
function vitePluginArcoImport(options = {}) {
    ...
    return {
        ...
        config(config, { command }) {
            ...
            less_1.modifyCssConfig(config, theme, modifyVars);
            // iconbox
            icon_1.modifyIconConfig(config, iconBox, iconBoxLib);
        },
        async load(id) {
            const res = icon_1.loadIcon(id, iconBox, iconBoxLib);
            if (res !== undefined) {
                return res;
            }
        ...
        transform(code, id) {
            // transform css files
            const res = transform_1.transformCssFile({
                code,
                id,
                theme,
            });
            ...
            // css lazy load
            return transform_1.transformJsFiles({
                code,
                id,
                theme,
                style,
