...
function Tooltip(baseProps, ref) {
    ...
    return (react_1.default.createElement(Trigger_1.default, __assign({ style: __assign({ maxWidth: 350 }, style), className: className, ref: refTrigger, classNames: "zoomInFadeOut", duration: triggerDuration, popup: function () {
            var _a;
